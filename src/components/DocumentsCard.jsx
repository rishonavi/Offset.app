  ...
  return (
    <Card className="p-5">
      <div className="mb-3 flex items-center gap-2">
        ...
        <h2 className="text-sm font-semibold text-ink-3">Documents</h2>
      </div>

      {sorted.length === 0 ? (
        <p className="text-sm text-ink-6">No documents yet — add a lease, insurance policy or warranty below.</p>
      ) : (
            ...
            return (
              <div key={d.id} className="flex items-center gap-3 py-2.5">
                ...
                <div className="min-w-0 flex-1">
                  <div className="truncate text-sm font-medium text-ink-2">{d.title}</div>
