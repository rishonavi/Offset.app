...
await p.locator('input[aria-label="Search expenses by vendor or note"]').fill('Adani')
...
await p.locator('input[aria-label="Search expenses by vendor or note"]').fill('')
await p.waitForTimeout(400)
...
await p.locator('input[aria-label="Search expenses by vendor or note"]').fill('zzzznothing')
await p.waitForTimeout(500)
